$(document).ready(function(){
  ...
  $("#create_special_comment").click(function(){
      ...
      var append_html = "<li><span class='extra_attribute'>" + name + "</span><span class='extra_attribute'>" + score + "</span><span class='extra_attribute'>" + drinkable_begin + ' - '+ drinkable_end + "</span>" + input_name + input_score + input_drinkable_begin + input_drinkable_end + "<a class='delete_special_comment icon_delet2' href='javascript:void(0);'></a></li>";
