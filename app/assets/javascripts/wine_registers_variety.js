$(document).ready(function(){
    $("#create_variety").click(function(){
        ...
        var input_name = "<input type='hidden' name='wines_register[variety_name][]' value='" + name + "'/>";
        var input_value = "<input type='hidden' name='wines_register[variety_percentage][]' value='" + value + "'/>";
